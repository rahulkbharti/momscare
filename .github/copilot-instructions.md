...
- [x] Clarify Project Requirements (Node.js tsc, name mom-care)
<!-- Ask for project type, language, and frameworks if not specified. Skip if already provided. -->

- [x] Scaffold the Project (package.json, tsconfig.json, src/index.ts, README.md)
<!--
...
- [x] Customize the Project (Skipped: Hello World)
<!--
